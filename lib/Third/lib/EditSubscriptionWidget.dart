...
class EditSubscriptionWidget extends StatefulWidget {
  ...
  EditSubscriptionWidget(
      {Key key, this.mode, this.item, this.ctx, this.currency})
      : super(key: key);
...
class _EditSubscriptionState extends State<EditSubscriptionWidget> {
  ...
  void initState() {
    ...
    if (widget.mode == "EDIT") {
      ...
      yearlyRenewDate =
          DateTime(DateTime.now().toLocal().year, dt.month, dt.day);
  ...
  String getYearlyDate() {
    return yearlyRenewDate == null
        ? ""
        : DateFormat('MM/dd').format(yearlyRenewDate);
  }
                                          ...
                                          onTap: () {
                                            ...
                                            if (cycle == "monthly" &&
                                              ...
                                              Scaffold.of(context)
                                                  .showSnackBar(SnackBar(
                                                content: Text(
                                                    'Your Date is invalid. Please Check again'),
                                                duration: Duration(seconds: 3),
                                              ));
                                              return;
                                            }
                                            if (widget.contentController.text
                                              ...
                                              Scaffold.of(context)
                                                  .showSnackBar(SnackBar(
                                                content: Text(
                                                    'Please enter what this subscription is about'),
                                                duration: Duration(seconds: 3),
                                              ));
                                              return;
                                            }
                                            entry.amount = roundDouble(
                                                num.parse(widget
                                                    .amountController.text),
                                                2);
                                            entry.content =
                                            ...
                                            if (cycle == "yearly") {
                                              ...
                                              if (day > 28) {
                                                day = 28;
                                                Scaffold.of(widget.ctx)
                                                    .showSnackBar(SnackBar(
                                                  content: Text(
                                                      'Day will be set to 28 instead for purpose of monthly recording.'),
                                                  duration:
                                                      Duration(seconds: 3),
                                                ));
                                              } else {
