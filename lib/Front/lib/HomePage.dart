...
ThemeData appTheme = ThemeData(
    ...
    /* Colors.tealAccent,*/
    secondaryHeaderColor: Colors.indigo /* Colors.teal*/
    // fontFamily:
    );
...
double width;
double height;
final bodies = [HomeScreen(), WishList(), ProfilePage()];
...
var selectedloc = 0;
List<String> locs = ['Dubai(DXB)', 'India (IND)'];
